...
#define BODY_FORCE 2000.0f // K (big K) 120000 / 80
#define AGENT_BODY_FORCE 1500.0f
#define SLIDING_FRICTION_FORCE 200.0f // k (small k) 240000 / 80 = 3000
...
#define WALL_A 40.0f //  proximity force importance
